...
Please note that we added an example of how the csv files for training adn validation must look like, using a very small portion of UHD-IQA dataset; located in the Dataset folder. This is only for the demo of training; please refer to the main dataset. 
